...
public:
    ...
    std::vector<QComboBox*> HostsData;
...
public:
    ...
    auto Free() -> void;
    auto LoadConfigFromFile() -> void;
    auto PopulateFieldsFromJson( const json& config ) -> void;
    auto ParseYAOTLListener( const QString& yaotlContent ) -> json;

protected slots:
    void onButton_Save();

    void onProxyEnabled();
    void onButton_LoadConfig();
};
