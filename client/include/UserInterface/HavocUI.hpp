...
public:
    ...
    QAction*               actionNetworkDiagram          = {};
    QAction*               actionLogs                    = {};
    QAction*               actionOnlineOperators         = {};
    QAction*               actionLoot                    = {};
    QAction*               actionServerLoot              = {};
    QAction*               actionUserManagement          = {};
    QAction*               actionAuditLogs               = {};
    ...
    QMenu*                 menuHavoc                     = {};
    QMenu*                 menuView                      = {};
    QMenu*                 menuNetworkDiagram            = {};
    QMenu*                 menuAdmin                     = {};
    QMenu*                 menuAttack                    = {};
    QMenu*                 menuScripts                   = {};
    QMenu*                 menuHelp                      = {};
    QStatusBar*            statusbar                     = {};
    QTabBar*               sessionViewTabBar             = {};
