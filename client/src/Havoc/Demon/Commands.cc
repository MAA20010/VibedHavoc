...
std::vector<DemonCommands::Command_t> DemonCommands::DemonCommandList = {
        ...
        },
        {
            ...
            .Behavior       = BEHAVIOR_API_ONLY,
            .Usage          = "[/path/to/file.txt] [aggressive]",
            .Example        = "c:\\secrets.txt aggressive",
            NO_SUBCOMMANDS
        },
        {
        ...
        },
        {
            ...
            .Usage          = "[subcommand]",
            .Example        = R"(inject atombomb x64 1337 /tmp/rev_shell.x64.bin)",
            .Module         = true,
            ...
            .SubCommands    =
            {
...

                {
                    ...
                    .Description    = "inject shellcode into a remote process\n\n"
                                     "THREADLESS METHODS:\n"
                                     "  window       Window Procedure Hijacking         [DEFAULT]\n"
                                     "  vectored     Vectored Exception Handler         \n"
                                     "  atombomb     Atom Bomb Injection                \n\n"
                                     "Thread-based methods:\n"
                                     "  callback     Timer callback infrastructure      \n"
                                     "  workitem     Thread pool work items            \n"
                                     "  fiber        Windows Fiber API execution        \n"
                                     "  manual       Manual DLL mapping               \n"
                                     "  exception    Exception handler redirection     \n",
                    .Behavior       = BEHAVIOR_PROCESS_INJECTION,
                    .MitreTechniques= {"T1055", "T1055.015", "T1055.014", "T1055.013"},
                    .Usage          = "[method] [arch] [target pid] [/path/to/shellcode.x64.bin]",
                    .Example        = R"(window x64 1337 /tmp/rev_shell.x64.bin)",
                },
