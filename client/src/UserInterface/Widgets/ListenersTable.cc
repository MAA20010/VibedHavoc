...
void HavocNamespace::UserInterface::Widgets::ListenersTable::ButtonsInit()
{
    ...
    QObject::connect( buttonRemove,  &QPushButton::clicked, this, [&]()
    {
        ...
        // Delete from UI immediately (server will send error if permission denied)
        // If error occurs, server broadcasts Listener::Add to restore it for unauthorized users
