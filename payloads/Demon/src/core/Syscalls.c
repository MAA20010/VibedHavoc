...
#ifdef HASH_DEBUG
    PRINTF( "SSN Extraction: NtDuplicateObject Ptr=%p SSN=0x%x\n", Instance->Win32.NtDuplicateObject, Instance->Syscall.NtDuplicateObject );
    PRINTF( "Syscall Config: SysIndirect=%d SysAddress=%p\n", Instance->Config.Implant.SysIndirect, Instance->Syscall.SysAddress );
#endif
