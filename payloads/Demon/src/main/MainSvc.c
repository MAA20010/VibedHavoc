...
VOID WINAPI SvcMain( DWORD dwArgc, LPTSTR* Argv )
{
    ...
    /* Report SERVICE_RUNNING to SCM immediately.
     * Without this, the service stays in START_PENDING forever —
     * a red flag visible via 'sc query' that IR analysts look for. */
