...
// Runtime function resolution to eliminate static function pointer signatures
typedef struct
{
    UINT32 CommandID;
    UINT_PTR EncryptedFunction;  // XOR encrypted function pointer (full pointer size)
} ENCRYPTED_COMMAND_ENTRY;
